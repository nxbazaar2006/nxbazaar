  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 lg:grid-cols-6">
          <div className="col-span-2 lg:col-span-2 lg:pr-8">
            ...
            <ul className="mt-9 flex items-center gap-3">
              ...
              <li>
                <a href="#" aria-label="Github" className={socialClass}>
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
            ...
            <form action="#" method="POST" className="mt-6">
              ...
              <button
                ...
                className="
                  ...
                  rounded-2xl bg-gradient-to-r from-orange-500
                  via-pink-500 to-purple-500 px-6 py-4
